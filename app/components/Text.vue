<template>
  <main class="min-h-screen flex items-center justify-center bg-[#f1f2f2]">
    <div class="flex flex-col sm:flex-row items-center justify-center text-center sm:text-left px-6 gap-8">

      <!-- متن ثابت - همه در یک خط -->
      <p class="font-bold text-[#848484] uppercase">
...
/* موبایل: اگر صفحه خیلی کوچیک شد، فقط کمی فونت رو کوچیک می‌کنیم (ولی همچنان یک خط) */
