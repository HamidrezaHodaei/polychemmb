        ...
        <div class="space-y-4 sm:space-y-5 md:space-y-6 sm:col-span-2 lg:col-span-1">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
              ...
              <a href="tel:+982122898979" class="footer-nav-link hover:text-white transition-colors">+98 21 2289 8979-80</a>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
              ...
              <a href="http://instagram.com/polychemm" class="footer-nav-link hover:text-white transition-colors">@Polychemm</a>
            </div>
