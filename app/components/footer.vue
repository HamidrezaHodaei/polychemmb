        ...
        <div class="space-y-4 sm:space-y-5 md:space-y-6 sm:col-span-2 lg:col-span-1">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
              ...
              <a href="tel:+982122898979" class="footer-nav-link hover:text-white transition-colors">+98 21 2289 8979</a>
            </div>
                <!-- Phone -->
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
              <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a href="tel:+982122898980" class="footer-nav-link hover:text-white transition-colors">+98 21 2289 8980</a>
            </div>
            <!-- Instagram -->
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
