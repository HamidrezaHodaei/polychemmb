        ...
        <div class="space-y-4 sm:space-y-5 md:space-y-6 sm:col-span-2 lg:col-span-1">
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
              ...
              <a href="mailto:info@polychemmb.com" class="footer-nav-link hover:text-white transition-colors break-all">
                info@polychemmb.com
              </a>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
              ...
              <span class="footer-nav-link">+98 21 2289 8979-80</span>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
              ...
              <a href="#" class="footer-nav-link hover:text-white transition-colors">@polychemmb</a>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-3 text-white text-xs sm:text-sm">
              ...
              <a href="#" class="footer-nav-link hover:text-white transition-colors">Polychem Company</a>
            </div>
          </div>
